...
VALUES (1000, '华星名仕集团', 0, 1, NULL, NULL, NULL, 0, 'admin', NOW(), 'admin', NOW(), 0, 1);

-- 2. 品牌层级
-- 一汽奥迪品牌
INSERT INTO system_dept (id, name, parent_id, sort, leader_user_id, phone, email, status, creator, create_time, updater, update_time, deleted, tenant_id) 
VALUES (1100, '一汽奥迪', 1000, 1, NULL, NULL, NULL, 0, 'admin', NOW(), 'admin', NOW(), 0, 1);

-- 上汽奥迪品牌
INSERT INTO system_dept (id, name, parent_id, sort, leader_user_id, phone, email, status, creator, create_time, updater, update_time, deleted, tenant_id) 
VALUES (1200, '上汽奥迪', 1000, 2, NULL, NULL, NULL, 0, 'admin', NOW(), 'admin', NOW(), 0, 1);

-- 小鹏品牌
INSERT INTO system_dept (id, name, parent_id, sort, leader_user_id, phone, email, status, creator, create_time, updater, update_time, deleted, tenant_id) 
VALUES (1300, '小鹏', 1000, 3, NULL, NULL, NULL, 0, 'admin', NOW(), 'admin', NOW(), 0, 1);
